# <div align="center">Messenger - Android just like Meta Facebook Messenger</div>

<BR><BR> 
    
My Messenger series   

<B>Series 1 - [Flutter Mobile App](https://github.com/samwelnyandoro/Messenger-Flutter)    <BR>
   Series 2 - [Flutter Web App](https://github.com/samwelnyandoro/Messenger-Flutter)     <BR>
   Series 3 - [Android App]()  - currently viewing    <BR> 
  <!-- Series 4 - [Web App using ReactJS & Firebase]()    <BR>  
   Series 4 - [Web App using Django & PostgreSQL]()   <BR>  -->
   Series 4 - [ChatBot using Natural Language Processing](https://github.com/samwelnyandoro/Retrieval-Chatbot)     <BR>
   Series 5 - [One-PC-Facebook  using C++ & File Handling]()  <BR><BR><BR>
   <H3> <div align="center">Series 3 - Android App</div>       </H3>   <BR><BR><BR>
</B>
...
- [Portfolio Website](https://samwelnyandoro1.netlify.app/)
- [Github](https://github.com/samwelnyandoro)
- [LinkedIn](https://www.linkedin.com/in/samwel-nyandoro-4aba9b190/)
- [Facebook](https://www.facebook.com/sammy.stennet.52/)
