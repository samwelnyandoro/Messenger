package dev.samwelnyandoro.messenger.view.ui;
...
import dev.samwelnyandoro.messenger.service.model.ChatWithModel;
import dev.samwelnyandoro.messenger.service.model.MessagesModel;
import dev.samwelnyandoro.messenger.service.model.UserModel;
import dev.samwelnyandoro.messenger.view.adapter.ChatPersonAdapter;
...
public class chat_person extends AppCompatActivity
{
   ...
   // String messageSenderId;
    ...
    void x()
    {
        ...
        db.collection("Samwel254").document("person").collection(chatwith_username)
                .get()
    ...
    private void SendMessage()
    {
       ...
       // message_textview.setText(message);
        ...
        else
        {
            ...
            db.collection("Samwel254").document("person").collection(chatwith_username).document(String.valueOf(System.currentTimeMillis())).set(msg).addOnSuccessListener(new OnSuccessListener<Void>()
                    {
