...
import dev.samwelnyandoro.messenger.UserGetData;
import dev.samwelnyandoro.messenger.databinding.SigninBinding;
import dev.samwelnyandoro.messenger.service.model.UserModel;
import dev.samwelnyandoro.messenger.view.ViewModelFactory.SignInViewModelFactory;
...
public class signin_signup extends AppCompatActivity
{
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState)
    {
        ...
        Toast.makeText(this, "haroooo", Toast.LENGTH_SHORT).show();
